...
class Vendor extends Model
{
    ...
    /* ('set') reserved word    ('Logo')name column in database      ('Attribute')reserved word  */
    ...
    /* ('set') reserved word    ('Password')name column in database      ('Attribute')reserved word  */
    /* by default the password  bcrypt */
