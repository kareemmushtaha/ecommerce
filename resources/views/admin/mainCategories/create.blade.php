                                            ...
                                            @if(get_languages()->count() > 0)
                                                @foreach(get_languages() as $index=> $lang)
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> اسم القسم باللغة ال <i
                                                                        style="color: red;"> {{__('massages.'.$lang->abbr)}}</i>
                                                                </label>
                                                        ...
                                                        <div class="col-md-6 hidden">
                                                            <div class="form-group">
                                                                <label for="projectinput1"> أختصار اللغة <i
                                                                        style="color: red;"> {{__('massages.'.$lang->abbr)}}</i></label>
                                                        ...
                                                        <div class="col-md-6">
                                                            <div class="form-group mt-1">
                                                                ...
                                                                <label for="switcheryColor4"
                                                                    ...
                                                                    الحالة {{__('massages.'.$lang->abbr)}}</label>
